...
export default function QuestionerLayout({
  ...
  return (
    <div className="flex-1 w-full flex flex-col md:flex-row">
      {/* LEFT */}
      <section className="w-full md:w-[40%] bg-surface">
        <div className="sticky top-20 h-fit lg:h-[calc(100vh-5rem)] flex flex-col p-12 md:p-20">
          <div className="max-w-md flex flex-col h-full">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-container/30 text-primary rounded-full mb-8 w-fit">
              <span
