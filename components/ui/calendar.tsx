  ...
  return (
     <DayPicker
      ...
      classNames={{
        ...
        range_middle: cn("rounded-r-(--cell-radius)", defaultClassNames.range_middle),
        range_end: cn(
          "relative isolate z-0 rounded-r-(--cell-radius) bg-muted after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-muted",
          defaultClassNames.range_end,
        ),
        today: cn(
          "rounded-(--cell-radius) bg-muted text-foreground data-[selected=true]:rounded-r-(--cell-radius)",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[range-start=true]:bg-yellow-700",
        "data-[range-start=true]:text-black",

        "data-[range-middle=true]:rounded-none",
        "data-[range-middle=true]:bg-yellow/15",
        "data-[range-middle=true]:text-yellow-500",

        "data-[range-end=true]:rounded-r-(--cell-radius)",
        "data-[range-end=true]:bg-yellow-700",
